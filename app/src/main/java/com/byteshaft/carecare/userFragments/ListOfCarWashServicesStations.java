...
public class ListOfCarWashServicesStations extends Fragment implements HttpRequest.OnReadyStateChangeListener,
    ...
    private void getServiceProvidersList(String baseLocation, ArrayList<Integer> service) {
        ...
        request.open("GET", String.format("%sfind-service-station?base_location=%s&service=%s",
