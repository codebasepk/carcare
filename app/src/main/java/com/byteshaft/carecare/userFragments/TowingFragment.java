...
import com.byteshaft.carecare.Adapters.CarTowingAdapter;
...
public class TowingFragment extends Fragment implements HttpRequest.OnReadyStateChangeListener,
    ...
    private CarTowingAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mBaseView = inflater.inflate(R.layout.fragment_towing_service, container, false);
        ...
        listView = mBaseView.findViewById(R.id.towing_list_view);
            ...
            case HttpRequest.STATE_DONE:
                ...
                switch (request.getStatus()) {
                    case HttpURLConnection.HTTP_OK:
                        arrayList = new ArrayList<>();
                        adapter = new CarTowingAdapter(getActivity(), arrayList);
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                CarTowingItems carTowingItems = new CarTowingItems();
                                carTowingItems.setServiceId(jsonObject.getInt("id"));
                                carTowingItems.setServiceName(jsonObject.getString("name"));
//                                carWashItems.setServicePrice(jsonObject.getString("service_price"));
                                arrayList.add(carTowingItems);
    ...
    private void getCarTowingServicesList() {
        request = new HttpRequest(getActivity());
        request.setOnReadyStateChangeListener(this);
        request.setOnErrorListener(this);
        request.open("GET", String.format("%stowing-services", AppGlobals.BASE_URL));
        request.send();
    ...
    public void onClick(View v) {
        ...
        ListOfCarTowingServicesProviders carTowingServicesProviders = new ListOfCarTowingServicesProviders();
        carTowingServicesProviders.setArguments(bundle);
        getFragmentManager().beginTransaction().replace(R.id.container, carTowingServicesProviders).commit();
